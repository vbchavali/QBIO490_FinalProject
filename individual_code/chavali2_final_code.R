...
boxplot(clinic$survival_time ~ clinic$gender,
        main = "Survival Data",
        xlab="sex",
        ylab = "Survival Time",)
...
gender_fit <- surv_fit( surv_object ~ clinic$gender, data = clinic )

# create the survplot
survplot = ggsurvplot(gender_fit, 
                      pval=TRUE, 
                      ggtheme = theme(plot.margin = unit(c(1,1,1,1), "cm")),
                      title = "surv time between male and female",
                      legend = "right")
...
survplot = ggsurvplot(gender_fit, 
                      pval=TRUE, 
                      ggtheme = theme(plot.margin = unit(c(1,1,1,1), "cm")), 
                      title = "Surv time with non-smoking between sex",
                      legend = "right")
...
survplot = ggsurvplot(gender_fit, 
                      pval=TRUE, 
                      ggtheme = theme(plot.margin = unit(c(1,1,1,1), "cm")), 
                      title = "Surv time with current smoker between sex",
                      legend = "right")
...
survplot = ggsurvplot(gender_fit, 
                      pval=TRUE, 
                      ggtheme = theme(plot.margin = unit(c(1,1,1,1), "cm")), 
                      title = "Surv time with more than 15 years smokers between sex",
                      legend = "right")
